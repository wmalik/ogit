...
var _ = Describe("Gitlab repo", func() {
	...
	It("Returns the matching repositories", func() {
		...
		Expect(repositories[0].GetOrgURL()).To(Equal("https://gitlab.com/greatuser"))
		Expect(repositories[0].GetIssuesURL()).To(Equal("https://gitlab.com/greatuser/dotfiles/issues"))
		Expect(repositories[0].GetCIURL()).To(Equal("https://gitlab.com/greatuser/dotfiles/pipelines"))
		Expect(repositories[0].GetReleasesURL()).To(Equal("https://gitlab.com/greatuser/dotfiles/releases"))
		Expect(repositories[0].GetSettingsURL()).To(Equal("https://gitlab.com/greatuser/dotfiles/edit"))
		...
		Expect(repositories[1].GetOrgURL()).To(Equal("https://gitlab.com/greatuser"))
		Expect(repositories[1].GetIssuesURL()).To(Equal("https://gitlab.com/greatuser/personal-website/issues"))
		Expect(repositories[1].GetCIURL()).To(Equal("https://gitlab.com/greatuser/personal-website/pipelines"))
		Expect(repositories[1].GetReleasesURL()).To(Equal("https://gitlab.com/greatuser/personal-website/releases"))
		Expect(repositories[1].GetSettingsURL()).To(Equal("https://gitlab.com/greatuser/personal-website/edit"))
